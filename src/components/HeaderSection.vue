    ...
    <div class="header__sticky">
      <div class="header__nav">
        <a class="header__hamburger" href="javascript:void(0)" @click="toggleSidebar" title="Open Sidebar">
          <svg viewBox="0 0 512 512" width="30px" height="30px" class="ion__svg"><path d="M64 384h384v-42.666H64V384zm0-106.666h384v-42.667H64v42.667zM64 128v42.665h384V128H64z"></path></svg>
        </a>
      </div>
...
export default {
  ...
  methods: {
    toggleSidebar: function () {
      this.$bus.$emit('setShowSidebar', true)
    }
  }
}
</script>
